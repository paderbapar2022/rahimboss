...
def rcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9,bn;q=0.8,id;q=0.7',
    'sec-ch-ua': '"Not:A-Brand";v="99", "Chromium";v="112"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"Infinix X693"',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11; Infinix X693) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36',
}
